...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_6 = Integer(6); _sage_const_12 = Integer(12)# Various functions to test
load('tau.sage')
...
def no_discrete_star(G):
    ...
    ans = {v:_sage_const_0  for v in G.vertices()}
    for e in G.edges():
        ans[e[_sage_const_0 ]] += _sage_const_1 /_sage_const_12  * F[e]**_sage_const_2 *e[_sage_const_2 ]**_sage_const_2  + _sage_const_1 /_sage_const_2 *R[e[_sage_const_0 ],_sage_const_0 ]* e[_sage_const_2 ]* F[e]
        ans[e[_sage_const_1 ]] += _sage_const_1 /_sage_const_12  * F[e]**_sage_const_2 *e[_sage_const_2 ]**_sage_const_2  + _sage_const_1 /_sage_const_2 *R[e[_sage_const_1 ],_sage_const_0 ]* e[_sage_const_2 ]* F[e]
    return ans
...
def first_derive_term(G):
    ...
    ans = {v:_sage_const_0  for v in G.vertices()}
    for e in G.edges():
        ans[e[_sage_const_0 ]] += (_sage_const_1  - G.degree(e[_sage_const_0 ])/_sage_const_2  + _sage_const_1 /_sage_const_2  * e[_sage_const_2 ] * F[e])
        ans[e[_sage_const_1 ]] += (_sage_const_1  - G.degree(e[_sage_const_1 ])/_sage_const_2  + _sage_const_1 /_sage_const_2  * e[_sage_const_2 ] * F[e])
    return ans

def first_derive_e_terms(G):
    R = resistance_matrix(G)
    F = fosters(G,R)
    ans = {e:_sage_const_0  for v in G.edges()}
    for e in G.edges():
        ans[e] += (_sage_const_1 /G.degree(e[_sage_const_0 ]) - _sage_const_1 /_sage_const_2  + _sage_const_1 /_sage_const_2  * e[_sage_const_2 ] * F[e])
    return ans
...
def no_F_L_2(G):
    ...
    ans = {v:_sage_const_0  for v in G.vertices()}
    for e in G.edges():
        ans[e[_sage_const_0 ]] += (_sage_const_1  - G.degree(e[_sage_const_0 ])/_sage_const_2  + _sage_const_1 /_sage_const_2  * e[_sage_const_2 ] * F[e])*R[e[_sage_const_0 ],_sage_const_0 ]
        ans[e[_sage_const_1 ]] += (_sage_const_1  - G.degree(e[_sage_const_1 ])/_sage_const_2  + _sage_const_1 /_sage_const_2  * e[_sage_const_2 ] * F[e])*R[e[_sage_const_1 ],_sage_const_0 ]
    return ans
...
def discrete_term(G):
    ...
    ans = {v:_sage_const_0  for v in G.vertices()}
    for e in G.edges():
        ans[e[_sage_const_0 ]] += (_sage_const_1  - G.degree(e[_sage_const_0 ])/_sage_const_2 ) * R[e[_sage_const_0 ],_sage_const_0 ]
        ans[e[_sage_const_1 ]] += (_sage_const_1  - G.degree(e[_sage_const_1 ])/_sage_const_2 ) * R[e[_sage_const_0 ],_sage_const_0 ]
    return ans
